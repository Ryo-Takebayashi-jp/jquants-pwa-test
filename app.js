...
if($("screenCfgSectorMode"))$("screenCfgSectorMode").onchange=()=>{const c=readScreeningConfigUi();c.sectorMode=$("screenCfgSectorMode").value;c.sectors=[];if($("screenCfgAllSectors"))$("screenCfgAllSectors").checked=true;renderScreeningSectorChoices(c)};
if($("screenCfgAllSectors"))$("screenCfgAllSectors").onchange=()=>renderScreeningSectorChoices(readScreeningConfigUi());
