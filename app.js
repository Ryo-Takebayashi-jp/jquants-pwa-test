...
(async()=>{if($("pfTradeDate")&&!$("pfTradeDate").value)$("pfTradeDate").value=await quickInvCanonicalDate();if($("pfTradePositions"))setTimeout(pfTradeRefresh,80)})();
