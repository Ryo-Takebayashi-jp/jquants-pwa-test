...
function ensureSqliteWorker(){
 ...
 const w=new Worker("./sqlite-worker.js?v=v7e-alpha80");
 jqSqliteWorker=w;
 w.onmessage=e=>{
...
if("serviceWorker"in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./service-worker.js?v=v7e-alpha80").catch(()=>{}));
...
// v7e-alpha80: advance the local DataLake one trading day with one operation, with current-day optional repair.
...
// v7e-alpha80: Watchlist private-state migration + unified Investment Tracking routing audit.
