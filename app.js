...
function ensureSqliteWorker(){
 ...
 const w=new Worker("./sqlite-worker.js?v=v7e-alpha103");
 jqSqliteWorker=w;
 w.onmessage=e=>{
...
// v7e-alpha103: daily-use direct Investment Tracking registration / update / Watchlist close UI.
