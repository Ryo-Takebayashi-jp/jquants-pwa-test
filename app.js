...
function ensureSqliteWorker(){
 ...
 const w=new Worker("./sqlite-worker.js?v=v7e-alpha89");
 jqSqliteWorker=w;
 w.onmessage=e=>{
...
if("serviceWorker"in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./service-worker.js?v=v7e-alpha89").catch(()=>{}));
...
function syncDailyDateInputs(date){
 const single=["simpleDailyDate","masterDate","finsDate","earningsDate","screeningAsOf","screeningBaseAsOf","parityAsOf","discoveryAsOf","factorAsOf","watchlistAlertAsOf"];
...
// v7e-alpha89: Watchlist private-state migration + unified Investment Tracking routing audit + Web-first alert layer.
...
let latestWatchlistWeb={master:[],state:[]},latestInvestmentRoutes={discovery:[],watchlist:[]};
...
// v7e-alpha89: Web-first Watchlist Re-Evaluation Alert engine.
