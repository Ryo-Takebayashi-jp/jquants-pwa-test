...
Per-release README files are no longer accumulated. New history is appended to milestone-range documents so repository and handoff uploads stay small.
